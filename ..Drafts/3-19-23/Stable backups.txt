...
function resetGameBoard() {
  ...
  cards.forEach(card => {
    card.classList.remove('card-locked', 'card-valid', 'card-flipped');
...
function showEndGameMessage(score) {
...
function endGame() {
  ...
  updateSuitTracker(currentGame, suitScores);   // Append scores to the scoretracker
  showEndGameMessage(totalScore);  // Display the end game message with total score
}
