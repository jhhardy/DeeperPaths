// Defining constants and giving the cards values XX
const cards = [
...
// Shuffle the cards using the Fisher-Yates algorithm XX
...
// Assign each card a value and point value XX
function dealCards() {
  ...
  // Set the suit class for each card element XX
  if (card.includes("♥")) {
